...
import { ArrowLeftIcon, PhotoIcon, CheckCircleIcon, UserIcon, GlobeAltIcon, EyeIcon, EyeSlashIcon } from '@heroicons/react/24/outline'
...
export default function EditarPerfilPage() {
    ...
    // Mock user data - en una app real esto vendría de un contexto o API
    const mockUser: User = {
        id: '1',
        name: 'María González',
        ...
        bio: 'Apasionada por el intercambio sostenible y la economía circular. Me encanta encontrar nuevos usos para objetos que ya no necesito.',
        location: 'Bogotá, Colombia',
        website: 'https://mi-sitio.com',
        instagram: '@maria_eco',
        facebook: 'maria.gonzalez.eco',
        twitter: '@maria_eco_swap',
        rating: 4.8,
    ...
    const handleInputChange = (field: string, value: string | boolean) => {
        if (field.includes('.')) {
            ...
            setFormData(prev => prev ? {
                ...prev,
                [parent]: {
                    ...(prev[parent as keyof User] as Record<string, unknown>),
                    [child]: value
                }
            } : null)
        } else {
