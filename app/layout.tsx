...
export const metadata: Metadata = {
    title: 'EcoSwap Colombia - Plataforma de Intercambio Sostenible',
    description: 'Plataforma líder en intercambio y venta de productos de segunda mano en Colombia. Promovemos la economía circular y el consumo sostenible.',
    keywords: 'intercambio, sostenible, ecología, segunda mano, reutilización, colombia, pereira',
    authors: [{ name: 'EcoSwap Team' }],
    ...
    metadataBase: new URL('https://ecoswap.co'),
    alternates: {
        canonical: '/',
        languages: {
            'es-CO': '/es',
    ...
    openGraph: {
        ...
        url: 'https://ecoswap.co',
        siteName: 'EcoSwap Colombia',
        images: [
            {
                url: '/og-image.jpg',
                width: 1200,
                height: 630,
                alt: 'EcoSwap Colombia',
            },
        ],
        locale: 'es_CO',
        type: 'website',
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            ...
                            <div className="col-span-1 md:col-span-2">
                                <div className="flex items-center space-x-3 mb-4">
                                    ...
                                    <span className="text-2xl font-bold">EcoSwap Colombia</span>
                                </div>
                                <p className="text-gray-300 mb-4 max-w-md">
                                    Plataforma líder en intercambio y venta de productos de segunda mano en Colombia.
                                    Promovemos la economía circular y el consumo sostenible.
                                </p>
                                <div className="flex space-x-4">
                                    ...
                                    <a href="https://www.instagram.com/eco__swap/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
