        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div className="flex-1 p-4 space-y-4">
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-1 mt-1">
                      ...
                      <span className="text-xs text-gray-600">{chatInfo?.seller?.rating?.toFixed(1) || '0.0'}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              {chatInfo?.offeredProduct && (
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-3">Producto Ofrecido</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium capitalize">{chatInfo.offeredProduct.type}</span>
                    </div>
                    {chatInfo.offeredProduct.price && (
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Precio:</span>
                        <span className="font-medium">${chatInfo.offeredProduct.price.toLocaleString()}</span>
                      </div>
                    )}
                    {chatInfo.offeredProduct.category && (
                      <div className="flex justify-between text-sm">
                ...
                {messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center py-12 empty-chat-container">
                    ...
                    <p className="text-gray-600 mb-4 max-w-md">
                      ...
                      <span className="font-semibold text-gray-800"> &ldquo;{chatInfo?.offeredProduct?.title}&rdquo;</span>
                    </p>
          </div>
        ) : (
